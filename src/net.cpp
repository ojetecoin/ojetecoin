...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Ojetecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"ojetecointools.com", "dnsseed.ojetecointools.com"},
    {"ojetecoinpool.org", "dnsseed.ojetecoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"ojetecointools.com", "testnet-seed.ojetecointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Ojetecoin is probably already running."), addrBind.ToString().c_str());
        else
